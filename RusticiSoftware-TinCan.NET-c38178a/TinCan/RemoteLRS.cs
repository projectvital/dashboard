...
namespace TinCan
{
    public class RemoteLRS : ILRS
    {
        ...
        {
            var queryParams = new Dictionary<String, String>();
            queryParams.Add("activityId", activity.id.AbsoluteUri);
        ...
        public LRSResponse SaveState(StateDocument state)
        {
            ...
            queryParams.Add("activityId", state.activity.id.AbsoluteUri);
        ...
        public LRSResponse SaveActivityProfile(ActivityProfileDocument profile)
        {
            ...
            queryParams.Add("activityId", profile.activity.id.AbsoluteUri);
